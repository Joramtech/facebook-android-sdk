...
object FacebookSdk {
    ...
    @Volatile
    private var codelessDebugLogEnabled: Boolean? = null
    ...
    @JvmField
    var ignoreAppSwitchToLoggedOut = false
    @JvmField
    var bypassAppSwitch = false
    ...
    @Volatile
    private var instagramDomain = INSTAGRAM_COM
    @Volatile
    private var facebookDomain = FACEBOOK_COM
    ...
    @JvmStatic
    fun isDebugEnabled(): Boolean = isDebugEnabledField
     ...
     */
    @JvmStatic
    fun isLegacyTokenUpgradeSupported(): Boolean = isLegacyTokenUpgradeSupported
     ...
     */
    @JvmStatic
    fun getFacebookDomain(): String = facebookDomain
     ...
     */
    @JvmStatic
    fun getFacebookGamingDomain(): String = FB_GG
     ...
     */
    @JvmStatic
    fun getInstagramDomain(): String = instagramDomain
     ...
     */
    @JvmStatic
    fun isInitialized(): Boolean = sdkInitialized.get()
    ...
    fun publishInstallAsync(context: Context, applicationId: String) {
        ...
        if (!FetchedAppGateKeepersManager.getGateKeeperForKey(
                AppEventsLoggerImpl.APP_EVENTS_KILLSWITCH,
                getApplicationId(),
                false
            )
        ) {
     ...
     */
    @JvmStatic
    fun getSdkVersion(): String = FacebookSdkVersion.BUILD
    ...
    internal fun loadDefaultsFromMetadata(context: Context?) {
        ...
        if (codelessDebugLogEnabled == null) {
            codelessDebugLogEnabled =
                ai.metaData.getBoolean(CODELESS_DEBUG_LOG_ENABLED_PROPERTY, false)
        }
    }
    ...
    @JvmStatic
    fun getAutoInitEnabled(): Boolean = UserSettingsManager.getAutoInitEnabled()
    ...
    @JvmStatic
    fun getCodelessSetupEnabled(): Boolean = UserSettingsManager.getCodelessSetupEnabled()
     ...
     */
    @JvmStatic
    fun getMonitorEnabled(): Boolean = UserSettingsManager.getMonitorEnabled()
